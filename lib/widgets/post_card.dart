...
import 'package:insta_flutter_fcc_yt/screens/comments_screen.dart';
import 'package:insta_flutter_fcc_yt/utils/colors.dart';
import 'package:insta_flutter_fcc_yt/utils/utils.dart';
import 'package:insta_flutter_fcc_yt/widgets/like_animation.dart';
            ...
            child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: RichText(
                      //can be used to create a paragraph combining different text styles and fonts...
                      text: TextSpan(
                        style: const TextStyle(
                          color: primaryColor,
                        ),
